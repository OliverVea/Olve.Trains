...
public sealed class DepotPlacingToolService(
    ToolManagementService toolManagementService,
    BuildingPlacementToolService buildingPlacementToolService,
    MouseRaycastService mouseRaycastService,
    MouseManager mouseManager,
    KeyboardManager keyboardManager)
    : BaseToolService<DepotPlacingToolService.PlacingState>(toolManagementService, new PlacingState())
{
    public static Id<Tool> ToolId { get; } = Id.New<Tool>();
    protected override Tool Tool => new(ToolId, "Place Depots");
    ...
    {
        _previewId = buildingPlacementToolService.Register(BuildingBlueprintCatalog.Depot);
        return base.Load();
    }
